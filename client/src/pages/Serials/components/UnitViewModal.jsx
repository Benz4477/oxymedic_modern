// src/pages/Serials/components/UnitViewModal.jsx
    ...
    >
      ...
      >
        ...
        <div className="sticky top-0 z-10 bg-white/95 backdrop-blur border-b border-slate-100 px-5 py-3 flex justify-between items-center rounded-t-2xl">
          ...
          <button
            onClick={onClose}
            className="w-7 h-7 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-500 transition flex items-center justify-center"
          >
            <X size={14} />
          </button>
        </div>
